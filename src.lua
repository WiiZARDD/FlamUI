...
function Library:create(options)
	...
	options = self:set_defaults({
		...
		Link = "https://wizhub.exploit/WiiZARDD/core"
	}, options)
	...
	creditsTab:credit{Name = "Abstract", Description = "UI Library Developer", Discord = "᲼᲼᲼᲼#0006", V3rmillion = "WiiZARDD"}
	creditsTab:credit{Name = "Deity", Description = "UI Library Developer", Discord = "᲼᲼᲼᲼#0006", V3rmillion = "WiiZARDD"}
